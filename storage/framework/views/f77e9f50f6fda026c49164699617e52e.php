            ...
            <form method="POST" action="<?php echo e(route('appointment.store')); ?>">
                ...
                <div class="mb-3">
                    ...
                    <input 
                        ...
                        min="<?php echo e(now()->format('Y-m-d')); ?>T09:00" 
                        max="<?php echo e(now()->addYear()->format('Y-m-d')); ?>T19:00" 
                        step="1800" 
                        required>
                </div>
...
<?php /**PATH C:\xampp\htdocs\doctor-appointment\resources\views/appointments/create.blade.php ENDPATH**/ ?>